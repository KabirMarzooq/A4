...
return [
     ...
     */
    'notifications' => [
        // Failures only — a daily "backup succeeded" email becomes noise
        // nobody reads, which defeats the point of alerting at all.
        'notifications' => [
        ...
        'mail' => [
            // env()'s own fallback only fires when the key is entirely
            // absent, not when it's present-but-empty (BACKUP_ALERT_EMAIL=
            // with nothing after it) — ?: catches that case too.
            'to' => env('BACKUP_ALERT_EMAIL') ?: (env('MAIL_FROM_ADDRESS') ?: 'your@example.com'),
